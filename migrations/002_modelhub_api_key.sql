...
CREATE INDEX IF NOT EXISTS modelhub_api_key_created_by_idx ON modelhub.modelhub_api_key (created_by);
CREATE INDEX IF NOT EXISTS modelhub_api_key_principal_id_idx ON modelhub.modelhub_api_key (principal_id);
